            ...
            xhr.onload = xhr.onerror = function() {
                ...
                if (this.status == 200) {
                    ...
                    if(this.response != 0) {
                    	...
                    	d.innerHTML = arr['id']+". <div class='tasks-text-wrap'>"+arr['text']+"</div><div class='mark-btn' onclick='client.mark("+arr['id']+")'></div><div class='delete-btn' onclick='client.delete("+arr['id']+")'></div></div>";
